...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "   \033[0;33mTu VPS${NC} $ipsaya \033[0;33mLamentablemente fue Baneada${NC}"
    echo -e "     \033[0;33mCOMPRA ACCESO AL SCRIPT${NC}"
    echo -e "             \033[0;33mContacto Admin :${NC}"
    echo -e "      \033[0;36mTelegram${NC} t.me/Jerry_SBG"
...
#THEME RED
cat <<EOF>> /etc/byjerrysbg/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
#THEME BLUE
cat <<EOF>> /etc/byjerrysbg/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
#THEME GREEN
cat <<EOF>> /etc/byjerrysbg/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
#THEME YELLOW
cat <<EOF>> /etc/byjerrysbg/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME MAGENTA
cat <<EOF>> /etc/byjerrysbg/theme/magenta
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME CYAN
cat <<EOF>> /etc/byjerrysbg/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
#THEME CONFIG
cat <<EOF>> /etc/byjerrysbg/theme/color.conf
blue
EOF
}
...
function password_default() {
    ...
    ============================
    (C) Copyright 2023 By SBG Project
    ============================
"
