...
wget -O /root/backup/ipmini https://raw.githubusercontent.com/aripTaz/permission/main/ip &> /dev/null
...
curl -F chat_id="$id_chat" -F document=@"$IP.zip" -F caption="Gracias Por Usar Mi Script
Dominio : $domain
IP VPS  : $IP
Fecha   : $date
Hora    : $time
