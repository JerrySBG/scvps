...
NC='\033[0m'
WH='\033[1;37m'
REPO="https://raw.githubusercontent.com/JerrySBG/SBG/main/"
cd
clear
slowsbg() {
clear  
echo -e "$RED╭═══════════════════════════════════════════╮${NC}"
echo -e "$RED│$NC         \e[1;32mConfigurar Dominio SlowDNS        $RED│${NC}"  
echo -e "$RED╰═══════════════════════════════════════════╯${NC}"
echo -e "$RED╭═══════════════════════════════════════════╮${NC}" 
echo -e "$RED│  [ 1 ]  \e[1;32mPropio Dominio SlowDNS                ${NC}"  
echo -e "$RED│  [ 2 ]  \e[1;32mDominio Aletorio Free                 ${NC}" 
#echo -e "$RED│  [ 3 ]  \e[1;32mDominio Aletorio By JERRY-SBG             ${NC}"                                
echo -e "$RED╰═══════════════════════════════════════════╯${NC}"
until [[ $slow =~ ^[1-2]+$ ]]; do 
...
clear
echo -e "$RED╭═══════════════════════════════════════════╮${NC}"
echo -e "$RED│$NC               \e[1;32mDOMINIO SLOWDNS             $RED│${NC}"  
echo -e "$RED╰═══════════════════════════════════════════╯${NC}"
echo -e "$RED╭═══════════════════════════════════════════╮${NC}"
echo -e "$RED│$NC  \e[1;32mDebes de tener Ya Configurado tu Dominio $RED│${NC}"  
echo -e "$RED╰═══════════════════════════════════════════╯${NC}"
...
ExecStart=/etc/slowdns/dnstt-client -udp 8.8.8.8:53 --pubkey-file /etc/slowdns/server.pub $nameserver 127.0.0.1:143
Restart=on-failure
