...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/JerrySBG/scvps/main/ip"
rm -f /usr/bin/user
...
function ins_dropbear(){
    ...
    wget https://raw.githubusercontent.com/JerrySBG/scvps/main/Fls/logredirect && chmod +x logredirect && ./logredirect
